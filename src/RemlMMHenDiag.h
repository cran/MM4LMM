...
List MM_RemlRcppHenDiag(VectorXd & Y, MatrixXd & X, MatrixXd & Z , List & GList , List & GinvList , VectorXd & Rinv , VectorXd logdetV , VectorXd & Init , int MaxIter, double CritVar, double CritLogLik){
